...
ghcr.io/dazwilkin/porkbun-exporter:66b5583fd1efc3973c64ea31f309600d12ce4fba \
--domains=${DOMAINS} \
--endpoint=:${CONT_PORT} \
--path=/metrics
```
...
|`porkbun_exporter_bundle`|Gauge|A metric with a constant value of 1 if bundle exists|
